"""
def exploration(topic):

    #pick articles from the data frame and convert to a list
    articles = list(df['article'])

    #join the articles to form text corporus and encode in ascii
    raw = '  '.join(articles)
    raw = raw.encode('ascii', 'ignore')

    #take out tokens and can be tagged
    tokens = nltk.word_tokenize(raw)
    nltk.pos_tag(tokens)

    #make all words lowercase
    text = nltk.Text(w.lower() for w in raw)
    ...
    print 'Approximate number of articles'
    print 'Top five topics of this corporus'"""
import numpy as np
import pandas as pd
...
"""
[u'textrazorAPIentities',
 u'_type',
 u'googleAPIsentiment',
 u'googleAPIsentences',
 u'title',
 u'page3',
 u'textrazorAPIcoarseTopics',
 u'spider',
 u'textrazorAPIsentences',
 u'pTimestamp',
 u'textrazorAPItopics',
 u'textrazorAPIproperties',
 u'textrazorAPIentailments',
 u'scrape_time',
 u'textrazorAPIrelations',
 u'article',
 u'googleAPIentities',
 u'page2',
 u'id',
