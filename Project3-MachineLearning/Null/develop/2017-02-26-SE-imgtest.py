...
imgdir = "/Users/scottedenbaum/Downloads/complete/images/" #sets ABS path to images on scott's home directory
img_list = []
itr = 0
try:
        ...
        for img in set(os.listdir(listingdir)): #parsing each image file
                       try:
                           if img.find('.jpg') > 0:
                               ...
                               print "Image Directory: " + imgdir + listing + '/' + '\n'
                               count_ += 1
                               ...
                               LuminanceC = round(np.sqrt( 0.241*R*R + 0.691*G*G + 0.068*B*B ),3)
...
print df_image
df_image.to_csv('../data/image_stats-fixed.csv')
