                  ...
                  fluidRow(
                    column(
                      ...
                      tags$h4("The Centers for Medicare and Medicaid (CMS) released Inpatient Charge Data from FY 2011, The Inpatient data describes the following
                              data elements:"),
                      tags$h4("DRG:A Diagnosis Related Group is a statistical system of classifying inpatient stays into groups for the purposes of payment. The CMS data provides average payments for providers organized by individual DRGs."),
                      tags$h4("Provider: Individual providers are described by their id, name and address."),
                      tags$h4("Total Discharges: This is simply the count of the number of discharges for that DRG and Provider."),
                      tags$h4("Average Covered Charges represent hospital billing costs, which are used as negotiating points and not particularly meaningful in terms of the actual amounts paid by Medicare. These are the charges that would be billed to a patient without insurance."),
                      tags$h4("Average Medicare Payments represent the average amount that Medicare pays to the provider for Medicare's share of the MS-DRG."),
                      tags$h4("Average Medicare Payments represent the average amount that Medicare pays to the provider for Medicare's share of the MS-DRG."),
