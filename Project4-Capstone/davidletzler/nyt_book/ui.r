...
shinyUI(dashboardPage(
  ...
  dashboardSidebar(
    ...
    sidebarMenu(
      ...
      selectInput("genre", "Select Imprint Genre", choices = c("All", "Commericial"="Commercial", "Spiritual"="Spiritual", "Literary"="Literary", "Genre" ="Genre", "Science Fiction & Fantasy"="Science Fiction & Fantasy", "Romance/Erotica"="Romance/Erotica", "Mystery/Crime"="Mystery/Crime", "Thriller/Horror"="Thriller/Horror")),
