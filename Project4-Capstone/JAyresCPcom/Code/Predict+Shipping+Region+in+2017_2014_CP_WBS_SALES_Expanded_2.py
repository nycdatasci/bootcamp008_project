...
# # Predicting Shipping Region in 2017_2014_CP_WBS_SALES_Expanded_2

# ### Notebook automatically generated from your model

# Model Logistic Regression, trained on 2017-03-27 17:24:08.

# #### Generated on 2017-03-28 13:22:16.514639

# prediction
# This notebook will reproduce the steps for a MULTICLASS on  2017_2014_CP_WBS_SALES_Expanded_2.
# The main objective is to predict the variable Shipping Region
...
ml_dataset = ml_dataset[[u'Purchase Date', u'Billing Last Name', u'Product Name 1', u'Billing First Name', u'email domain', u'Total Quantity', u'Shipping Region', u'Web Visits for Day', u'Conversion Rate to Visits', u'Day', u'Gender', u'Year', u'Quantity 1', u'Purchase Total', u'Conv Rate to Web Hits', u'Shipping Last Name', u'Shipping First Name', u'Month', u'Total Order Qty', u'Web Hits for Day', u'Repeat Purchaser', u'Billing Email', u'Weekday']]
...
categorical_features = [u'Purchase Date', u'Billing Last Name', u'Product Name 1', u'Billing First Name', u'email domain', u'Conversion Rate to Visits', u'Gender', u'Conv Rate to Web Hits', u'Shipping Last Name', u'Shipping First Name', u'Month', u'Billing Email', u'Weekday']
numerical_features = [u'Total Quantity', u'Web Visits for Day', u'Day', u'Year', u'Quantity 1', u'Purchase Total', u'Total Order Qty', u'Web Hits for Day', u'Repeat Purchaser']
text_features = []
...
target_map = {u'West': 2, u'New England': 4, u'MIdAtlantic': 5, u'East': 0, u'MidWest': 3, u'South': 1}
ml_dataset['__target__'] = ml_dataset['Shipping Region'].map(str).map(target_map)
del ml_dataset['Shipping Region']
...
impute_when_missing = [{'impute_with': u'MEAN', 'feature': u'Total Quantity'}, {'impute_with': u'MEAN', 'feature': u'Web Visits for Day'}, {'impute_with': u'MEAN', 'feature': u'Day'}, {'impute_with': u'MEAN', 'feature': u'Year'}, {'impute_with': u'MEAN', 'feature': u'Quantity 1'}, {'impute_with': u'MEAN', 'feature': u'Purchase Total'}, {'impute_with': u'MEAN', 'feature': u'Total Order Qty'}, {'impute_with': u'MEAN', 'feature': u'Web Hits for Day'}, {'impute_with': u'MEAN', 'feature': u'Repeat Purchaser'}]
...
categorical_to_dummy_encode = [u'Purchase Date', u'Billing Last Name', u'Product Name 1', u'Billing First Name', u'email domain', u'Conversion Rate to Visits', u'Gender', u'Conv Rate to Web Hits', u'Shipping Last Name', u'Shipping First Name', u'Month', u'Billing Email', u'Weekday']
...
rescale_features = {u'Total Quantity': u'AVGSTD', u'Web Hits for Day': u'AVGSTD', u'Web Visits for Day': u'AVGSTD', u'Total Order Qty': u'AVGSTD', u'Quantity 1': u'AVGSTD', u'Purchase Total': u'AVGSTD', u'Year': u'AVGSTD', u'Repeat Purchaser': u'AVGSTD', u'Day': u'AVGSTD'}
...
results_test = results_test.rename(columns= {'__target__': 'Shipping Region'})
